    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "User",
                columns: new[] { "Id", "AccountStatus", "Email", "Name", "PasswordHash" },
                values: new object[,]
                {
                    { 1, 1, "admin@auth.com", "Admin", "$MYHASH$V1$10000$VJxXfJgEqxIsEYF3B40nl+PjbO+hFmTjQvaYjG5ToUxDQnEL" },
                    { 2, 1, "user@auth.com", "User", "$MYHASH$V1$10000$Xo1MyMQfHUtiwzC45SDxhlQ8GAUtcJELJPGrFoghOMUTH9/o" }
                });
